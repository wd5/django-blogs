...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogsBlog.description'
        db.add_column('blogs_blogsblog', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'BlogsBlog.status'
        db.add_column('blogs_blogsblog', 'status',
                      self.gf('django.db.models.fields.CharField')(default='active', max_length=15, db_index=True),
                      keep_default=False)

        # Adding field 'BlogsPost.image'
        db.add_column('blogs_blogspost', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.BlogsPostImage'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogsBlog.description'
        db.delete_column('blogs_blogsblog', 'description')

        # Deleting field 'BlogsBlog.status'
        db.delete_column('blogs_blogsblog', 'status')

        # Deleting field 'BlogsPost.image'
        db.delete_column('blogs_blogspost', 'image_id')
