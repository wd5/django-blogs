...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogsBlog.post_count'
        db.add_column('blogs_blogsblog', 'post_count',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BlogsBlog.comment_count'
        db.add_column('blogs_blogsblog', 'comment_count',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogsBlog.post_count'
        db.delete_column('blogs_blogsblog', 'post_count')

        # Deleting field 'BlogsBlog.comment_count'
        db.delete_column('blogs_blogsblog', 'comment_count')
